...
Created a new virtual machine named: Server01
...
The Windows Server installation ISO was attached through: Settings → Storage → Optical Drive
...
During the first startup attempt, VirtualBox displayed: FATAL: No bootable medium found! System halted.
